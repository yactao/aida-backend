...
class QueryIterator {
    ...
    async createHybridQueryExecutionContext(queryPlan, diagnosticNode) {
        ...
        this.queryExecutionContext = new hybridQueryExecutionContext_js_1.HybridQueryExecutionContext(this.clientContext, this.resourceLink, this.query, this.options, queryPlan, this.correlatedActivityId, queryRanges);
    }
