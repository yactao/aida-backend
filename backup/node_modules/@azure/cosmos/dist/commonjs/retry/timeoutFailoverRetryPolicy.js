...
exports.TimeoutFailoverRetryPolicy = void 0;
...
class TimeoutFailoverRetryPolicy {
    ...
    isValidRequestForTimeoutError() {
        const isQuery = constants_js_1.Constants.HttpHeaders.IsQuery in this.headers;
        const isQueryPlan = constants_js_1.Constants.HttpHeaders.IsQueryPlan in this.headers;
        if (this.methodType === index_js_1.HTTPMethod.get || isQuery || isQueryPlan) {
            return true;
        }
        return false;
    }
...
exports.TimeoutFailoverRetryPolicy = TimeoutFailoverRetryPolicy;
