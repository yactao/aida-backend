...
async function execute({ diagnosticNode, retryContext = { retryCount: 0 }, retryPolicies, requestContext, executeRequest, }) {
    ...
    return (0, diagnostics_js_1.addDiagnosticChild)(async (localDiagnosticNode) => {
        ...
        if (!retryPolicies) {
            retryPolicies = {
                endpointDiscoveryRetryPolicy: new endpointDiscoveryRetryPolicy_js_1.EndpointDiscoveryRetryPolicy(requestContext.globalEndpointManager, requestContext.resourceType, requestContext.operationType, requestContext.globalPartitionEndpointManager),
