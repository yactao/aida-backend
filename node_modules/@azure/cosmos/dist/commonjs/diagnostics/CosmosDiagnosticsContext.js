...
class CosmosDiagnosticContext {
    ...
    recordEncryptionDiagnostics(encryptionDiagnostics) {
        ...
        const encryptionDuration = encryptContent[index_js_1.Constants.Encryption.DiagnosticsDuration] ?? 0;
        const decryptionDuration = decryptContent[index_js_1.Constants.Encryption.DiagnosticsDuration] ?? 0;
