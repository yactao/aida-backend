...
exports.EncryptionKeyStoreProvider = void 0;
...
class EncryptionKeyStoreProvider {
    ...
    async clearCacheOnTtlExpiry() {
        this.cacheRefresher = (0, time_js_1.startBackgroundTask)(async () => {
            const now = new Date();
...
exports.EncryptionKeyStoreProvider = EncryptionKeyStoreProvider;
