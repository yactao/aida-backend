...
async function httpRequest(requestContext, diagnosticNode) {
    ...
    if ((requestContext.connectionPolicy.enablePartitionLevelFailover ||
        ...
        requestContext.resourceType === constants_js_1.ResourceType.item &&
        (0, index_js_1.isReadRequest)(requestContext.operationType)) {
        requestTimeout = Math.min(requestContext.connectionPolicy.requestTimeout, constants_js_1.Constants.RequestTimeoutForReadsInMs);
    }
    ...
    const httpsClient = requestContext.httpClient ?? (0, cachedClient_js_1.getCachedDefaultHttpClient)();
