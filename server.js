...
async function initializeDatabase() {
    ...
    try {
        ...
        result = await database.containers.createIfNotExists({ id: 'EduMessages', partitionKey: '/threadId' });
        db.eduMessagesContainer = result.container;
